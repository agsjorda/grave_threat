...
export const HELP_MULTIPLIER_FEATURE_TITLE = 'help_multiplier-feature-title';
export const HELP_MULTIPLIER_FEATURE_DESC = 'help_multiplier-feature-desc';
...
export const LOCALIZATION_DEFAULTS: Record<string, string> = {
  ...
  [POPUP_BUYFEAT_CARD_TITLE]: "Nathan's Goolish Gold bonus v",
